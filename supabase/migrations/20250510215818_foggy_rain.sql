/*
  # Fix shop owner authentication

  1. Changes
    - Add proper auth.users columns and metadata
    - Update shop owner relationship
    - Fix RLS policies
    - Add correct test data

  2. Security
    - Enable RLS
    - Add proper policies for shop access
*/
...
-- Insert test shop owner user
DO $$
BEGIN
  -- Create shop owner user with all required fields
