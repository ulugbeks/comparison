/*
  # Add shop reviews and test users

  1. New Data
    - Creates test users for reviews
    - Adds sample shop reviews with ratings and comments
  
  2. Changes
    - Inserts test users first to satisfy foreign key constraints
    - Adds reviews with proper user references
*/
...
-- Add sample reviews after users exist
