/*
  # Add sample shop reviews

  1. Changes
    - Add sample reviews for the test shop
    - Add user_name field to reviews
    - Add review policies

  2. Security
    - Reviews are viewable by everyone
    - Users can only create one review per shop
...
INSERT INTO shop_reviews (
  ...
  (
    '00000000-0000-0000-0000-000000000001', -- Test shop ID
    '00000000-0000-0000-0000-000000000003', -- Test user ID
    5,
...
-- Create additional test users for reviews if they don't exist
DO $$
BEGIN
