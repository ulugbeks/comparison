/*
  ...
  1. Tables Created
    - shops: Store information about vendors/shops
    - shop_owners: Link shops with their owners (users)
    - shop_reviews: Store customer reviews for shops
  ...
  3. Test Data
    - Create test users (admin, shop owner, regular user)
