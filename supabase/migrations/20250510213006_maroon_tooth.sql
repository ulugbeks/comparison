/*
  ...
  1. New Tables
    - shops (store information about vendors)
    - shop_owners (link shops to user accounts)
...
BEGIN
    ...
    DROP POLICY IF EXISTS "Shops can be updated by owners" ON shops;
    DROP POLICY IF EXISTS "Shop owners are viewable by everyone" ON shop_owners;
    DROP POLICY IF EXISTS "Admins can manage shop owners" ON shop_owners;
